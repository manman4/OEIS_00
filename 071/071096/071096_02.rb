...
# A071096
# Independent enumeration by perfect matchings, without using a product or
# determinant formula for A071096.
#
# The region is the hexagon with side lengths
# n, n+1, n+2, n, n+1, n+2.
...
#
# Usage:
#   ruby 071096_02.rb       # n = 0..12
#   ruby 071096_02.rb 20    # n = 0..20
...
def build_graph(n)
  triangles = hexagon_triangles(n)
  up = triangles.select(&:up)
  down = triangles.reject(&:up)
  expected_per_color = 3 * n * n + 6 * n + 2
